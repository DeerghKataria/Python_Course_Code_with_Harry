...
# t[0] = 34 ---> This can't be done, this is one of the downside of using tuple.
...
# t2 = (1)  
# print(t2)
# ---> This is the wrong way of doing it. It won't be able to tell
# that a tuple is being declared.

print(t.count(1))   # ---> Tell us the number of occurences
print(t.index(5))   # ---> Tell us about the Index
